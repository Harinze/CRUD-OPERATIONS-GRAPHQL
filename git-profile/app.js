...
const token = "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"
...
function getRepo(resp) {
  ...
  const query = `{graphql
    viewer {
      ...
      bio
      avatarUrl(size: 260)
      repositories(last: 50, orderBy: {field: UPDATED_AT, direction: DESC}) {
        nodes {
          name
          updatedAt
          stargazerCount
...
// https://64bf4441eae4591c8d9f2444--lovely-caramel-9f8393.netlify.app/
